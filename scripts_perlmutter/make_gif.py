...
parser.add_argument('--folder', default='../plots_Pythia_nominal_standard', help='Folder containing figures')
...
parser.add_argument('--pt', type=int, default=14, help='Number of pT bins')
...
for to_gif in plot_list:
    frames = []
    for i in range(1,flags.pt):
        new_frame = Image.open(os.path.join(base_folder,"{}_{}_{}.png".format(to_gif,flags.niter, i)))
