...
parser.add_argument('--data_folder', default='/pscratch/sd/j/jing/H1PCT/scripts_perlmutter/files/mom_8th', help='Folder containing the results to plot')
...
parser.add_argument('--ptmax', type=int, default=0, help='Max pT to consider for faster testing')
...
folder = 'results'
plot_folder = '/pscratch/sd/j/jing/H1PCT/scripts_perlmutter/mom_sys'
